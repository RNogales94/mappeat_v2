...
ALLOWED_HOSTS = ['www.mappeat.com','mappeat.com', '127.0.0.1', '85.214.200.178']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mappeatdb',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'userdb',
        'PASSWORD': 'neyumansa',
        'HOST': 'localhost',                      # Empty for localhost through domain sockets or 127.0.0.1
        'PORT': '5432',
    }
}
